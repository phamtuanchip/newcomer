...
public class UIPopupAction extends UIContainer {
  ...
  public <T extends UIComponent> T activate(Class<T> type, int width, int height) throws Exception {
    return activate(type, null, width, height);
  }
