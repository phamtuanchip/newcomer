...
public class BookStorageTest extends TestCase {
  ...
  private static StandaloneContainer sContainer;
  ...
  private static void initContainer() {
    sContainer = ComponentLocator.getContainer();
  }
  ...
  public void testLoginToWorkSpace() throws Exception
  {
    ...
    RepositoryService repoSer = (RepositoryService) 
        sContainer.getComponentInstance(RepositoryService.class);
    Session session = repoSer.getRepository("repository").login
    (
     new SimpleCredentials( BookstoreConstant.USERNAME_REPOSITORY, 
  ...
  public void testGettingBookStorageComponent() 
  {
    ...
    bookStorage = (BookStorageImpl) sContainer.getComponentInstanceOfType(BookStorageImpl.class);
